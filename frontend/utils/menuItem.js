...
if(window) window.addEventListener('mousemove', ev => mousepos = getMousePos(ev));
...
export default class MenuItem {
    ...
    layout() {
        ...
        this.DOM.previewArea = document.getElementsByClassName('previewArea')[0]
    ...
    hideImage() {
        ...
        this.tl = gsap.timeline({
            onStart: () => {
                gsap.set(this.DOM.previewArea, {zIndex: 1});
